...
export const SceneIntro: React.FC<SceneIntroProps> = ({
  ...
  return (
    <div className="w-full h-full flex flex-col justify-start sm:justify-center items-center px-4 sm:px-8 lg:px-12 pt-20 sm:pt-22 pb-6 relative scene-scroll allow-native-scroll">
      ...
      <div className="max-w-4xl w-full mx-auto space-y-3 sm:space-y-4 md:space-y-5 my-auto relative z-10 text-left rtl:text-right">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center gap-2 text-[11px] sm:text-xs font-mono font-bold tracking-wider"
        >
        ...
        <motion.div
          ...
          className="w-full"
        >
          <div className="h-16 sm:h-24 md:h-32 lg:h-36 max-h-[18vh] w-full relative">
            <ParticleTextCanvas
        ...
        >
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold tracking-tight text-[#1A1816] font-syne leading-snug max-w-2xl">
            {isAr ? (
              <>
          ...
          <p className="text-xs sm:text-sm text-[#554F48] font-normal leading-relaxed max-w-2xl">
            {isAr
        ...
        <motion.div
          ...
          className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5 pt-0.5"
        >
          {PERSONAL_INFO.stats.map((stat, idx) => (
            <div key={idx} className="p-2 sm:p-2.5 bg-white border border-[#E2DDD5] modern-flat-shadow space-y-0.5">
              <div className="text-sm sm:text-base font-bold font-syne text-[#0284C7]">
                {stat.value}
              </div>
              <div className="text-[10px] sm:text-[11px] font-mono text-[#6B655F]">
                {stat.label[lang]}
              </div>
            </div>
          ))}
        ...
        >
          <button
            ...
            className="px-4 py-2 sm:px-5 sm:py-2.5 bg-[#0284C7] hover:bg-[#0369A1] text-white text-xs sm:text-sm font-bold transition-all shadow-md shadow-[#0284C7]/20 flex items-center gap-2 cursor-pointer active:scale-98"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 sm:px-5 sm:py-2.5 bg-[#1A1816] hover:bg-[#332E29] text-white text-xs sm:text-sm font-bold transition-all shadow-md flex items-center gap-2 cursor-pointer"
          >
          ...
          <button
            onClick={onContact}
            className="px-4 py-2 sm:px-5 sm:py-2.5 bg-white hover:bg-[#FAF8F5] border border-[#D5CFC5] text-[#1A1816] text-xs sm:text-sm font-bold transition-all modern-flat-shadow hover:border-[#0284C7] flex items-center gap-2 cursor-pointer"
          >
